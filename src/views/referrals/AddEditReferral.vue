        ...
        <Form @submit="onSubmit" :validation-schema="schema" :initial-values="user" v-slot="{ errors, isSubmitting }">
            <div class="form-row">
                <div class="form-group col">
                    <label>Persona Type</label> <!-- For a Referral ADD it should be merchant not Merchant is true or false? -->
                    <input type="radio" id="yes" value="true" v-model="picked">
                    <label for="yes">Yes</label>
                    <br>
                    <input type="radio" id="no" value="false" v-model="picked">
                    <label for="no">No</label>
                    <Field name="personaType" type="text" class="form-control" :class="{ 'is-invalid': errors.personaType }" />
